...
public class MediumRubyTempleFeature extends AbstractTempleFeature<DefaultFeatureConfig>
{
    public MediumRubyTempleFeature()
    {
    ...
    public static class SimpleStructureStart extends StructureStart
    {
        ...
        {
            DefaultFeatureConfig defaultFeatureConfig = chunkGenerator.getStructureConfig(biome, Features.getFeature("medium_ruby_temple"));
            ...
            MediumRubyTempleGenerator.addParts(structureManager, startingPos, rotation, this.children, this.random, defaultFeatureConfig);
