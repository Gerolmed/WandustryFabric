...
public class MediumRubyTempleGenerator
{
    public static final Identifier id = new Identifier(WandustryMod.MOD_ID, "temples/ruby/medium_ruby_temple");
    ...
    {
        list_1.add(new MediumRubyTempleGenerator.Piece(structureManager, id, blockPos, rotation));
    }
    ...
    public static class Piece extends SimpleStructurePiece
    {
        ...
        public Piece(StructureManager structureManager_1, CompoundTag compoundTag_1) {
            super(Features.getPiece("medium_ruby_temple"), compoundTag_1);
        ...
        {
            super(Features.getPiece("medium_ruby_temple"), 0);
        ...
        public void setStructureData(StructureManager structureManager)
        {
            ...
            StructurePlacementData structurePlacementData_1 = (new StructurePlacementData()).setRotation(this.rotation).setMirrored(BlockMirror.NONE).setPosition(pos).addProcessor(BlockIgnoreStructureProcessor.IGNORE_AIR);
        ...
        public boolean generate(IWorld iWorld_1, Random random_1, MutableIntBoundingBox mutableIntBoundingBox_1, ChunkPos chunkPos_1)
        {
            ...
            this.pos = this.pos.add(0, yHeight - 3, 0);
