...
public class SmallEmeraldTempleFeature extends AbstractTempleFeature<DefaultFeatureConfig>
{
    public SmallEmeraldTempleFeature()
    {
    ...
    public static class SimpleStructureStart extends StructureStart
    {
        ...
        {
            DefaultFeatureConfig defaultFeatureConfig = chunkGenerator.getStructureConfig(biome, Features.getFeature("small_emerald_temple"));
            ...
            SmallEmeraldTempleGenerator.addParts(structureManager, startingPos, rotation, this.children, this.random, defaultFeatureConfig);
